...
func RemoteServersInit() {
	...
	cmdCreate.Flags().StringVar(&paramsRemoteServerCreate.AzureFilesShareName, "azure-files-share-name", "", "Azure File Storage Share name")
	cmdCreate.Flags().StringVar(&paramsRemoteServerCreate.AzureFilesSasToken, "azure-files-sas-token", "", "Shared Access Signature (SAS) token")
	...
	cmdUpdate.Flags().StringVar(&paramsRemoteServerUpdate.AzureFilesShareName, "azure-files-share-name", "", "Azure File Storage Share name")
	cmdUpdate.Flags().StringVar(&paramsRemoteServerUpdate.AzureFilesSasToken, "azure-files-sas-token", "", "Shared Access Signature (SAS) token")
