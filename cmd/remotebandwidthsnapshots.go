...
func RemoteBandwidthSnapshots() *cobra.Command {
	RemoteBandwidthSnapshots := &cobra.Command{
		...
		Short: "A RemoteBandwidthSnapshot is a remote bandwidth report for the given date.",
	...
	cmdList.Flags().Int64Var(&paramsRemoteBandwidthSnapshotList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
