...
func BundleRecipientsInit() {
	...
	cmdList.Flags().IntVarP(&paramsBundleRecipientList.UserId, "user-id", "u", 0, "List Bundle Recipients")
	...
	cmdList.Flags().IntVarP(&paramsBundleRecipientList.BundleId, "bundle-id", "b", 0, "List Bundle Recipients")
