...
func SettingsChangesInit() {
	...
	cmdList := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			client := settings_change.Client{Config: *ctx.GetConfig()}
	...
	cmdList.Flags().Int64VarP(&paramsSettingsChangeList.PerPage, "per-page", "p", 0, "Number of records to show per page.  (Max: 10,000, 1,000 or less is recommended).")
