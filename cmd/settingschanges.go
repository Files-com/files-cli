...
func SettingsChanges() *cobra.Command {
	...
	cmdList.Flags().StringVar(&paramsSettingsChangeList.ApiKeyId, "api-key-id", "", "If set, return records where the specified field is equal to the supplied value.")
	cmdList.Flags().StringVar(&paramsSettingsChangeList.UserId, "user-id", "", "If set, return records where the specified field is equal to the supplied value.")
