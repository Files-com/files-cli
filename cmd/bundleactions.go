...
func BundleActions() *cobra.Command {
	...
	cmdList.Flags().StringVar(&paramsBundleActionList.Action, "action", "", "")
	cmdList.Flags().Int64Var(&paramsBundleActionList.Page, "page", 0, "")
	cmdList.Flags().Int64Var(&paramsBundleActionList.BundleId, "bundle-id", 0, "Bundle ID")
	cmdList.Flags().Int64Var(&paramsBundleActionList.BundleRegistrationId, "bundle-registration-id", 0, "BundleRegistration ID")
