...
func BundleActions() *cobra.Command {
	BundleActions := &cobra.Command{
		...
		Short: "A BundleAction is an action performed on a bundle.",
	...
	cmdList.Flags().Int64Var(&paramsBundleActionList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
	cmdList.Flags().Int64Var(&paramsBundleActionList.BundleId, "bundle-id", 0, "Bundle ID")
	cmdList.Flags().Int64Var(&paramsBundleActionList.BundleRegistrationId, "bundle-registration-id", 0, "Bundle Registration ID")
