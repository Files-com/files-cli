...
func AppsInit() {
	...
	cmdList := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			client := app.Client{Config: files_sdk.GlobalConfig}
	...
	cmdList.Flags().IntVarP(&paramsAppList.PerPage, "per-page", "p", 0, "Number of records to show per page.  (Max: 10,000, 1,000 or less is recommended).")
