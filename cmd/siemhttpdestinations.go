...
func SiemHttpDestinations() *cobra.Command {
	...
	cmdCreate.Flags().StringVar(&paramsSiemHttpDestinationCreate.AzureDcrImmutableId, "azure-dcr-immutable-id", "", "Applicable only for destination type: azure. Immutable ID of the Data Collection Rule.")
	...
	cmdCreate.Flags().StringVar(&paramsSiemHttpDestinationCreate.AzureOauthClientCredentialsTenantId, "azure-oauth-client-credentials-tenant-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Tenant ID.")
	cmdCreate.Flags().StringVar(&paramsSiemHttpDestinationCreate.AzureOauthClientCredentialsClientId, "azure-oauth-client-credentials-client-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Client ID.")
	...
	cmdSendTestEntry.Flags().StringVar(&paramsSiemHttpDestinationSendTestEntry.AzureDcrImmutableId, "azure-dcr-immutable-id", "", "Applicable only for destination type: azure. Immutable ID of the Data Collection Rule.")
	...
	cmdSendTestEntry.Flags().StringVar(&paramsSiemHttpDestinationSendTestEntry.AzureOauthClientCredentialsTenantId, "azure-oauth-client-credentials-tenant-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Tenant ID.")
	cmdSendTestEntry.Flags().StringVar(&paramsSiemHttpDestinationSendTestEntry.AzureOauthClientCredentialsClientId, "azure-oauth-client-credentials-client-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Client ID.")
	...
	cmdUpdate.Flags().StringVar(&paramsSiemHttpDestinationUpdate.AzureDcrImmutableId, "azure-dcr-immutable-id", "", "Applicable only for destination type: azure. Immutable ID of the Data Collection Rule.")
	...
	cmdUpdate.Flags().StringVar(&paramsSiemHttpDestinationUpdate.AzureOauthClientCredentialsTenantId, "azure-oauth-client-credentials-tenant-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Tenant ID.")
	cmdUpdate.Flags().StringVar(&paramsSiemHttpDestinationUpdate.AzureOauthClientCredentialsClientId, "azure-oauth-client-credentials-client-id", "", "Applicable only for destination type: azure. Client Credentials OAuth Client ID.")
