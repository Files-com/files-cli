...
func Notifications() *cobra.Command {
	...
	cmdList.Flags().Int64Var(&paramsNotificationList.UserId, "user-id", 0, "User ID.  Provide a value of `0` to operate the current session's user.")
	...
	cmdList.Flags().StringVar(&paramsNotificationList.Action, "action", "", "")
	cmdList.Flags().Int64Var(&paramsNotificationList.Page, "page", 0, "")
