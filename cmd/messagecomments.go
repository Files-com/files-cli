...
func MessageComments() *cobra.Command {
	MessageComments := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return clierr.Errorf(clierr.ErrorCodeUsage, "invalid command message-comments\n\t%v", args[0])
		},
	}
	...
	cmdList.Flags().StringVar(&listSortByArgs, "sort-by", "", "Sort message comments by field in ascending or descending order.")
	...
	cmdList.Flags().Int64Var(&paramsMessageCommentList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
