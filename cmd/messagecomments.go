...
func MessageCommentsInit() {
	...
	cmdList := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			client := message_comment.Client{Config: files_sdk.GlobalConfig}
	...
	cmdList.Flags().IntVarP(&paramsMessageCommentList.PerPage, "per-page", "p", 0, "Number of records to show per page.  (Max: 10,000, 1,000 or less is recommended).")
