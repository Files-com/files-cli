...
func EventDeliveryAttempts() *cobra.Command {
	EventDeliveryAttempts := &cobra.Command{
		...
		Short: "An EventDeliveryAttempt records delivery state for an EventRecord and EventTarget.",
	...
	cmdList.Flags().Int64Var(&paramsEventDeliveryAttemptList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
