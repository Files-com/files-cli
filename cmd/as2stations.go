...
func As2Stations() *cobra.Command {
	As2Stations := &cobra.Command{
		...
		Short: "An AS2Station is a remote AS2 server that can send data into Files.com and receive data from Files.com.",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			return clierr.Errorf(clierr.ErrorCodeUsage, "invalid command as2-stations\n\t%v", args[0])
		},
	}
	...
	cmdList.Flags().StringVar(&listSortByArgs, "sort-by", "", "Sort as2 stations by field in ascending or descending order.")
	lib.SetFlagDisplayType(cmdList.Flags(), "sort-by", "field=asc|desc")
	cmdList.Flags().StringArrayVar(&listFilterArgs, "filter", []string{}, "Find as2 stations where field exactly matches value.")
	...
	cmdList.Flags().Int64Var(&paramsAs2StationList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
