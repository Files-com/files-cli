...
func DesktopConfigurationProfiles() *cobra.Command {
	...
	cmdList.Flags().Int64Var(&paramsDesktopConfigurationProfileList.PerPage, "per-page", 0, "Number of records to show per page.  (Max: 10000, 1,000 or less is recommended).")
