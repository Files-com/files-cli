...
func UsageDailySnapshotsInit() {
	...
	cmdList := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			client := usage_daily_snapshot.Client{Config: files_sdk.GlobalConfig}
	...
	cmdList.Flags().IntVarP(&paramsUsageDailySnapshotList.PerPage, "per-page", "p", 0, "Number of records to show per page.  (Max: 10,000, 1,000 or less is recommended).")
