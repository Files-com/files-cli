...
func Users() *cobra.Command {
	...
	cmdCreate.Flags().StringVar(&paramsUserCreate.GrantPermission, "grant-permission", "", "Permission to grant on the user root.  Can be blank or `full`, `read`, `write`, `list`, `read+write`, or `list+write`")
	...
	cmdUpdate.Flags().StringVar(&paramsUserUpdate.GrantPermission, "grant-permission", "", "Permission to grant on the user root.  Can be blank or `full`, `read`, `write`, `list`, `read+write`, or `list+write`")
