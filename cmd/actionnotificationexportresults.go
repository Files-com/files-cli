...
func ActionNotificationExportResults() *cobra.Command {
	...
	cmdList.Flags().StringVar(&paramsActionNotificationExportResultList.Action, "action", "", "")
	cmdList.Flags().Int64Var(&paramsActionNotificationExportResultList.Page, "page", 0, "")
