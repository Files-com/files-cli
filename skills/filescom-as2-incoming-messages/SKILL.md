---
name: filescom-as2-incoming-messages
description: |
  An AS2IncomingMessage is a single record created for each individual AS2 file transfer incoming from a Partner.
---

# filescom-as2-incoming-messages
